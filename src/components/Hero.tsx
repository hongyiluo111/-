      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 mb-10 md:mb-0">
            <h1 className="mb-4 text-4xl font-bold leading-tight animate-fade-in md:text-5xl lg:text-6xl">
              专业电竞陪玩平台
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-delay-2">
              <MagneticButton
                as="a"
                href="/find-companion"
                className="btn btn-primary text-center transform hover:scale-105 magnetic-btn"
                strength={14}
              >
                找陪玩
              </MagneticButton>
              <MagneticButton
                ...
                className="btn border-white/70 bg-white text-primary text-center transform hover:scale-105 hover:bg-white/90 magnetic-btn"
                strength={14}
              >
                成为陪玩
              </MagneticButton>
              <MagneticButton
                ...
                className="btn border border-white/70 text-center text-white transform hover:scale-105 hover:bg-white/10 magnetic-btn"
                strength={14}
              >
                了解电竞行业发展
              </MagneticButton>
