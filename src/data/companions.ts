...
export const allCompanions: Companion[] = [
  ...
  // VALORANT (10个)
  { id: 51, name: '小M', game: 'VALORANT', rank: '钻石', price: 70, avatar: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=young%20male%20gamer%20avatar%2C%20val%2C%20esports%20profile&image_size=square', description: '捷风绝活哥，击杀机器' },
  { id: 52, name: '阿Jet', game: 'VALORANT', rank: '超凡', price: 110, avatar: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=young%20male%20gamer%20avatar%2C%20immortal%2C%20esports%20profile&image_size=square', description: '亚服超凡大师' },
  { id: 53, name: '小Sage', game: 'VALORANT', rank: '铂金', price: 55, avatar: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=young%20female%20gamer%20avatar%2C%20support%2C%20esports%20profile&image_size=square', description: '最好用的奶妈，队友存活保障' },
  { id: 54, name: '阿Reyna', game: 'VALORANT', rank: '钻石', price: 85, avatar: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=young%20female%20gamer%20avatar%2C%20duelist%2C%20esports%20profile&image_size=square', description: '刷子大拿，收割能力强' },
  { id: 55, name: '小Omen', game: 'VALORANT', rank: '神话', price: 140, avatar: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=young%20male%20gamer%20avatar%2C%20radiant%2C%20esports%20profile&image_size=square', description: '全球前500神话玩家' },
  { id: 56, name: '阿C', game: 'VALORANT', rank: '铂金', price: 50, avatar: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=young%20male%20gamer%20avatar%2C%20controller%2C%20esports%20profile&image_size=square', description: '烟子控场，战术大师' },
  { id: 57, name: '小Viper', game: 'VALORANT', rank: '钻石', price: 75, avatar: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=young%20female%20gamer%20avatar%2C%20sentinel%2C%20esports%20profile&image_size=square', description: '毒蛇使用者，防守专家' },
  { id: 58, name: '阿K', game: 'VALORANT', rank: '黄金', price: 40, avatar: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=young%20male%20gamer%20avatar%2C%20initiator%2C%20esports%20profile&image_size=square', description: '信息收集者，团队大脑' },
  { id: 59, name: '小Jett', game: 'VALORANT', rank: '超凡', price: 100, avatar: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=young%20female%20gamer%20avatar%2C%20flanker%2C%20esports%20profile&image_size=square', description: '飘逸打法，秀翻全场' },
  { id: 60, name: '阿Sova', game: 'VALORANT', rank: '铂金', price: 52, avatar: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=young%20male%20gamer%20avatar%2C%20scout%2C%20esports%20profile&image_size=square', description: '侦查专家，情报大师' },
